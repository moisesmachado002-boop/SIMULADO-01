const CACHE = 'mentor-ia-v2-6-layout-v2';
const ASSETS = [
  './','./index.html','./styles.css','./layout-refresh.css','./q-mode.css','./q-presets.css','./auth.css','./bank-mode.css','./qg-theme.css','./qg-mode.css','./edital-core.css','./question-filters.css','./question-difficulty.css','./question-feedback.css','./app.js','./q-mode.js','./q-presets.js','./cloud-sync.js','./runtime-bootstrap.js','./bank-mode.js','./qg-mode.js','./review-engine.js','./schedule-engine.js','./study-profile.js','./edital-core.js','./question-state.js','./question-filters.js','./question-difficulty.js','./question-feedback.js','./manifest.json','./icon.svg'
];
